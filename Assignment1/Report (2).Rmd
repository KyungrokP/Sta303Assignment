...
# Conclusion
Overall,  our analysis uses the Negative Binomial regression model as the variance-mean ratio of the Poisson regression model exceeds 1. The log-likelihood test further confirms that the negative binomial model with the offset is the most suitable as it has the least negative log-likelihood, -8909.044. Additionally, @fig3 shows there is no significant interaction effect between literacy status and age at marriage, indicating that these variables affect family size independently. Based on the Hypothesis testing, the variables (illiterate women, women married at 15 to 18, women married at 18 to 20, Lisbom region, the region with 20k+population, and the region with 10-20k population) with p-values smaller than 0.05 against the null hypothesis of no impact on family size, which indicated these variable are significant effect on family size.

In conclusion, both literacy and age at marriage impacted the family size in Portugal in the 1980s. Women who are married between 15 and 18 and between 18 and 20 are more likely to have a higher birth rate in Portugal. Women marrying between 15-20 years old have an around 10% higher incidence rate compared with those who married later. It is similar to Ekorinano et al. (2023)'s research in Indonesia, which found that women who married before they were 25 years old tend to have a bigger family size. Illiterate women in Portugal were 6–9% more likely to have larger families compared to literate women, similar to trends observed in Uganda. Additionally, urban areas in Portugal experienced lower birth rates than rural ones, and there is no preference for sons, unlike in countries such as Korea.
